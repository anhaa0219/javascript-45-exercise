...
if (xp >= levelUpAt) {
  ...
  xp = xp - 200;
  console.log("1level " + xp + "xp");
} else {
  console.log(200 - xp + "Needed for level up!");
}
// ----- 4. Tip calculator -----
...
let scor = 45;
let attendExtraClass = true;
if (scor >= 50 || (scor >= 45 && attendExtraClass === true)) {
  console.log("Pass");
} else {
  console.log("Fail");
}
...
const correctUser = "anhaa";
const correctPass = "anhaa-best";
let enteredUser = "anhaa";
let enteredPass = "anhaa-best";
let isLocked = true;
if (
  isLocked === true &&
